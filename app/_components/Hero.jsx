...
function Hero() {
  return (
    <section className="bg-[#EFF6FF] mb-20">
          ...
          <div>
            <div className="max-w-lg md:max-w-none">
              ...
              <p className="my-4 text-gray-500">
                Book appointments with top doctors, specialists, and healthcare
                providers near you. Manage your health with ease - anytime,
                anywhere. Your health, our priority.
              </p>
